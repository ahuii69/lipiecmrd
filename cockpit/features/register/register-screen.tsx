...
import { LoginBrandPanel } from "@/features/login/login-brand-panel";
    ...
    return (
        ...
        >
            ...
            <div className="space-y-2">
                <div className="mx-auto h-7 w-52 animate-pulse rounded-lg bg-white/10 lg:mx-0" />
                ...
                <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 py-8 sm:px-6 lg:px-10">
                    <div className="mb-8 flex items-center gap-3 lg:hidden">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-neutral-500">Pierwsze konto</p>
                        </div>
                    </div>
