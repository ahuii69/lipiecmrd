...
export function SimulationsPanel() {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ["cockpit-simulations", session.userId],
        queryFn: () =>
            apiClient.cockpitSimulations(
                session.userId,
                20,
    ...
    if (!data) {
        return (
            <EmptyState
                title="No simulations data"
                description="Run agent cycles to generate simulations"
            />
        );
    }
        ...
        <div className="space-y-3">
            ...
            {simulations.length > 0 && (
                <Card>
                    ...
                    <CardContent>
                        <JsonView title="Simulations" value={simulations} />
                    </CardContent>
                </Card>
            )}
